...
export const Footer = () => {
  ...
  return (
    <footer className="relative bg-black text-white">
      ...
      <div className="grid lg:grid-cols-4 gap-20 sm:grid-cols-1 p-20 bg-gradient-to-r from-pink-500 to-yellow-500">
        <div className="flex flex-col gap-5">
          <h2 className="text-3xl text-white-500">Footer</h2>
          <p style={{color:'white'}}>
        ...
        <div className="mb-4 md:mb-0">
          <h2 className="text-[22px] font-semibold text-white-500 py-2 uppercase">
            Contact
          </h2>
          <p className="text-[16px] my-4" style={{color:'white'}}>Email: youremail.gmail.com</p>
          <p className="text-[16px] my-4" style={{color:'white'}}>Phone: +1 113-456-7890</p>
      ...
      <h6 className="text-center">&copy; copyright LibraLite {Year}</h6>
